...
/* harmony import */ var _modules_popup_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/popup.js */ "./js/modules/popup.js");
/* harmony import */ var _modules_glazing_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/glazing.js */ "./js/modules/glazing.js");
/* harmony import */ var _modules_calc_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/calc.js */ "./js/modules/calc.js");
/* harmony import */ var _modules_decor_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/decor.js */ "./js/modules/decor.js");
/* harmony import */ var _modules_gallery_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/gallery.js */ "./js/modules/gallery.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_glazing_js__WEBPACK_IMPORTED_MODULE_1__["glazing"])();
  Object(_modules_calc_js__WEBPACK_IMPORTED_MODULE_2__["calc"])();
  Object(_modules_decor_js__WEBPACK_IMPORTED_MODULE_3__["decor"])();
  Object(_modules_gallery_js__WEBPACK_IMPORTED_MODULE_4__["gallery"])();
  Object(_modules_form_js__WEBPACK_IMPORTED_MODULE_5__["form"])();
  Object(_modules_timer_js__WEBPACK_IMPORTED_MODULE_6__["timer"])();
});
...
function calc() {
  var close = document.querySelectorAll('.close'),
      ...
      calcData = new FormData(); //окно "форма и размеры"
  ...
  var currentImg = function currentImg(a) {
    for (var i = a; i < balconImg.length; i++) {
  ...
  var showImg = function showImg(b) {
  ...
  height.oninput = replaceCalcInput; //переход на мод. окно profile + форма-ширина
  ...
  var statusCalcMessage = document.createElement('div');
  ...
  function sendCalcForm(elem) {
    elem.addEventListener('submit', function (event) {
      ...
      for (var i = 0; i < calcFormInput.length; i++) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "decor", function() { return decor; });
//TABs DECORATION
function decor() {
  var decorSwitch = document.querySelector('.decoration_slider'),
  ...
  var hideDecor = function hideDecor(a) {
    for (var i = a; i < decorContent.length; i++) {
  ...
  var showDecor = function showDecor(b) {
  ...
  decorSwitch.addEventListener('click', function (event) {
    var target = event.target;
...
function form() {
  ...
  var primaryForm = document.querySelectorAll('.primary_form'),
...
//GALLERRY
function gallery() {
  var imageBox = document.querySelectorAll('.img-box'),
  ...
  overlay.addEventListener('click', function (event) {
    if (event.target.className != 'image-box' || event.target.className != 'box') {
      ...
      overlayDiv.style.display = 'none'; //image.style.display = 'none';
...
/***/ "./js/modules/glazing.js":
/*!*******************************!*\
  !*** ./js/modules/glazing.js ***!
  \*******************************/
/*! exports provided: glazing */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "glazing", function() { return glazing; });
// TABs GLAZING
function glazing() {
  var glazingTabSwitch = document.querySelector('.glazing_slider'),
  ...
  var hideGlazingTab = function hideGlazingTab(a) {
    for (var i = a; i < glazingTabContent.length; i++) {
  ...
  var showGlazingTab = function showGlazingTab(b) {
    glazingTabContent[b].style.display = "flex";
  };

  glazingTabSwitch.addEventListener('click', function (event) {
    var target = event.target;
...
//POPUPs
function popup() {
  var popupEngineerBtn = document.querySelector('.popup_engineer_btn'),
      ...
      overlay = document.querySelector('.overlay'); //show popup

  var showEngineerPopup = function showEngineerPopup(event) {
  ...
  callbackFeedback.addEventListener('click', showPopup); //close popup 
  ...
  var laterPopup = function laterPopup(event) {};
